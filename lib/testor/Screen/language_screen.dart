...
//         children: [
//           SizedBox(height: 40,),
//           regularText(title: 'Select the language', textWeight: FontWeight.w600, textSize: 18, textColor: Colors.blue),
//           Expanded(
//               child: ListView.builder(
//                   itemCount: languageNames.length,
//                   itemBuilder: (context, index){
//                     final translation = controller.catLang[index];
...
//                   ),
//                   child: ListTile(
//                     title: regularText(title: languageNames[index], textWeight: FontWeight.w600, textSize: 16, textColor: _selectedIndex == index
//                         ? Colors.white
//                         : Colors.black,),
//                     subtitle: regularText(title: translation.spanish, textWeight: FontWeight.w300, textSize: 14, textColor: Colors.grey),
//                     leading: Icon(Icons.self_improvement_rounded, color: Colors.blue,),
//                   ),
//                 ),
//               ),
//             );
